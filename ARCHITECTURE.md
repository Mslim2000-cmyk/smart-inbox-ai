# Smart Inbox AI Architecture

The initial version of this document was created by Google Gemini 2.0 Flash Thinking Experimental 01-21.

The Smart Inbox AI repository is a portfolio adaptation of the [Inbox Zero](https://github.com/elie222/inbox-zero) monorepo, consisting of the main web application (`apps/web`), supporting deployable apps, and shared packages.
