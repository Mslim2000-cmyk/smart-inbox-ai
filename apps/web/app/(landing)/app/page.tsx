...
export const metadata: Metadata = {
  ...
  description: `${BRAND_NAME} on iPhone and Android. Organize your inbox, draft replies, and stay on top of your inbox from anywhere.`,
      ...
      <Section className="mt-10 md:mt-20">
        ...
        <BlurFade duration={0.4} delay={0.125 * 2}>
          <Paragraph size="lg" className="mx-auto mt-6 max-w-[640px]">
            ...
            inbox, draft replies in your voice, and stay on top of your inbox from
            anywhere.
          </Paragraph>
        </BlurFade>
