...
export const footerNavigation = {
  ...
  support: [
    ...
    {
      name: "Inbox Zero Status (upstream)",
...
export function Footer() {
  const copyrightName =
    BRAND_NAME === "Inbox Zero" ? "Inbox Zero Inc." : `${BRAND_NAME} — portfolio adaptation based on Inbox Zero`;
