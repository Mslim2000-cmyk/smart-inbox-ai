...
export function Awards() {
  return (
    <Section>
      ...
      <SectionSubtitle>
        Your data stays private — no AI training, no funny business. The base
        project is fully certified for top-tier security, and you can even
        self-host the app if you want total control.
      </SectionSubtitle>
      <SectionContent
        noMarginTop
